...
export class ReportService {
    static async getDashboard(userId, role) {
        if (role === 'CONSIGNOR') {
            const [myProductsCount, myConsignmentsCount, mySalesCount, myEarningsAgg, recentConsignments,] = await Promise.all([
        ...
        // CONSIGNEE Dashboard
        const [assignedConsignments, acceptedConsignments, mySalesCount, myEarningsAgg, recentSales,] = await Promise.all([

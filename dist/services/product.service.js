...
export class ProductService {
    static async getProducts(query) {
        ...
        const where = {};
        if (query.consignorId)
            where.consignorId = query.consignorId;
        if (query.categoryId) {
            where.categories = {
    ...
    static async createProduct(consignorId, data) {
    ...
    static async updateProduct(id, userId, userRole, data) {
    ...
    static async addProductImage(productId, imageUrl, isPrimary = false) {
